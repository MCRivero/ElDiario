...
// SETTERS //
	...
	public function setDateAjout($dateAjout)
		{
			if (is_string($dateAjout) && preg_match('"el [0-9]{2}/[0-9]{2}/[0-9]{4} à [0-9]{2}h[0-9]{2}"', $dateAjout))
				{
	...
	public function setDateModif($dateModif)
		{
			if (is_string($dateModif) && preg_match('"el [0-9]{2}/[0-9]{2}/[0-9]{4} à [0-9]{2}h[0-9]{2}"', $dateModif))
				{
